...
export type PanelView = 'resources' | 'employees' | 'infrastructure' | 'models' | 'research' | 'business' | 'settings' | null;
  ...
  return (
    <section className={styles.controls}>
      ...
      <div className={styles.panelTabs}>
        ...
        <button
          type="button"
          className={`${styles.btn} ${activeView === 'models' ? styles.btnActive : ''}`}
        ...
        <button
          type="button"
          className={`${styles.btn} ${activeView === 'research' ? styles.btnActive : ''}`}
          onClick={() => toggleView('research')}
          aria-pressed={activeView === 'research'}
        >
          研发
        </button>
        <button
          type="button"
          className={`${styles.btn} ${activeView === 'business' ? styles.btnActive : ''}`}
          onClick={() => toggleView('business')}
        ...
        <button
          type="button"
          className={`${styles.btn} ${activeView === 'settings' ? styles.btnActive : ''}`}
